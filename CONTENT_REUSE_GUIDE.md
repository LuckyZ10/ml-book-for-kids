...
```
1. 查指南 → 看本文件，确认有哪些可用内容
2. 找文件 → 在 chapters-old/ deprecated/ chapters-unified/ 中定位
3. 评估 → 判断是否值得融合（质量、相关性）
4. 融合 → 将内容整合到 chapters/chapter-XX-主题/ 下
5. 删除 → 确认融合成功后，删除源文件
6. 记录 → 更新本指南，标记已整理
```
...
### 删除前确认清单
- [ ] 内容已完整复制到目标章节
- [ ] 格式已转换为新标准 (README.md + code/ + exercises.md + references.bib)
- [ ] 原始文件已备份 (git commit)
- [ ] 删除后不影响其他章节引用
